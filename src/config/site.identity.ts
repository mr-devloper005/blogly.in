export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'blogly',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Blogly',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'blogly.in',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://blogly.in',
